  ...
  return (
    <>
      ...
      <div className="py-8">
        ...
        <div className="px-3">
          <div className="flex justify-between border-b border-solid pb-3 border-gray-200">
            <div className="flex gap-2">
              <img src="/assets/Bid1-min.png" alt="" className="size-16 shrink-0 object-cover" />
              <div className="text-sm text-blue-dark">
                <p className="line-clamp-2">1965 Gibson SG Standard Electric Guitar</p>
      ...
      <div className="py-4 flex items-center justify-between px-3">
        ...
        <p className="text-sm font-medium">$10000</p>
      </div>
    </>
  );
};
